...
public class ScheduleFlight2Contoller {

	Main m=new Main();
	public URL location;
	
	@FXML
	private Button CalculateFareBtn;
	
	public ScheduleFlight2Contoller() {
	...
	public void goToCalculateFare(ActionEvent event) throws IOException {
		
		Stage s=(Stage)((Node)event.getSource()).getScene().getWindow();
		m.CalculateFareScene(s);
	}
