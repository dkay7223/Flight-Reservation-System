...
public class UpdateAirplaneStatus2Controller {
	...
	public UpdateAirplaneStatus2Controller() {
		// TODO Auto-generated constructor stub
	}
	
	public void goToUpdateAirplaneStatus3(ActionEvent event) throws IOException {
		
		Stage s=(Stage)((Node)event.getSource()).getScene().getWindow();
		m.UpdateAirplaneStatus3Scene(s);
