...
public class UpdateAirplaneStatusController {
	...
	public UpdateAirplaneStatusController() {
		// TODO Auto-generated constructor stub
	}
	
	public void goToUpdateAirplaneStatus2(ActionEvent event) throws IOException {
		
		Stage s=(Stage)((Node)event.getSource()).getScene().getWindow();
		m.UpdateAirplaneStatus2Scene(s);
