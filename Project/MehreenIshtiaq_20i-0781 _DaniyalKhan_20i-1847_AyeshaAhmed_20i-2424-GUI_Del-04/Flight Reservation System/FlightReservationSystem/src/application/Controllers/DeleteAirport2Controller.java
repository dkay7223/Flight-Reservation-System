...
public class DeleteAirport2Controller {
	...
	public DeleteAirport2Controller() {
	...
	public void goToDeleteAirport3(ActionEvent event) throws IOException {
		
		Stage s=(Stage)((Node)event.getSource()).getScene().getWindow();
		m.DeleteAirport3Scene(s);
