...
public class UpdateRoute2Controller {

	Main m=new Main();
	public URL location;
	
	public UpdateRoute2Controller() {
	...
	public void goToUpdateRoute3(ActionEvent event) throws IOException {
